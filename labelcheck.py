...
def generate_synthetic_document(output_dir, num_pages=10, text_file_path="text.txt", bg_images_path="./backgrounds", font_path="arial.ttf"):
    ...
    for page_num in range(num_pages):
        ...
        bg_image.save(img_path, format='JPEG', quality=50)
...
# Example usage
generate_synthetic_document(output_dir="./dataset/train/checked", num_pages=5, text_file_path="text.txt")

def visualize_labels(image_dir, label_dir, num_images=5):
    ...
    for i in range(min(num_images, len(image_files))):
        ...
        with open(label_path, 'r') as f:
            for line in f:
                ...
                x1, y1, x2, y2 = float(coords[0]), float(coords[1]), float(coords[4]), float(coords[5])
...
# Example usage
visualize_labels(image_dir="./dataset/train/images", label_dir="./dataset/train/labels", num_images=5)